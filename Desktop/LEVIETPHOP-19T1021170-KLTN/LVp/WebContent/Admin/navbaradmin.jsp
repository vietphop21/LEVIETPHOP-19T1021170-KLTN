		...
		<div class="brand">
			<ul>
				<li><a href="QLLoaiAdminController"><i class="fa fa-wrench"
						aria-hidden="true"></i>Quản lý loại</a></li>
				<li><a href="QLHangADMINController"><i class="fa fa-wrench"
						aria-hidden="true"></i>Quả1111n lý hàng</a></li>
				<li><a href="xacnhanController">Xác nhận đặt hàng</a></li>
				<li><a href="QLKhachHangController">Quản lí Khách Hàng</a></li>
			</ul>
		</div>
		<ul>
			<li><div class="wrap">
					<form action="QLHangADMINController" class="search" method="post">
